...
WIN_WIDTH = 600 #Breite des Ausgabefensters
...
bird_starting_x = 230 # Startposition Vogel x, x = konst.
...
x_first_pipe = 700 # Startposition des ersten Röhrenpaares (wird außerhalb des Windows generiert)
x_add_new_pipe = 225
x_new_pipe = 600
x_remove_pipe = 0
