...
#Rohrpaare
gap_y = 175 # Abstand zwischen Unterkante des oberen Rohres und Oberkante des unteren Rohtes (Flugschneise)
pipe_vel = 5 # horizontale Geschwindigkeit der Rohrpaare = Geschwindigkeit des Bodens
random_min_height = 100 # the minimum height of the top pipe (carefully set this number)
...
def eval_genomes(genomes, config):
    ...
    while run and len(birds) > 0:
        ...
        for pipe in pipes:
            ...
            if pipe.x + pipe.TOP_PIPE.get_width() < 300:
                rem.append(pipe)
